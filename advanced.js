...
function enhanceImage(img){
 ...
 img.sizes=img.classList.contains('hero-photo')?'100vw':img.closest('dialog')?'(max-width: 740px) 85vw, 650px':'(max-width: 600px) calc(100vw - 40px), (max-width: 900px) 45vw, 33vw';
 img.decoding='async';
}
